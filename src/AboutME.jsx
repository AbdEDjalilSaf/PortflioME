...
<div className='slides'>
  <div className='logoSlides flex items-center'>
  <LazyLoadImage src='/image/html.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
  <LazyLoadImage src='/image/css.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
  <LazyLoadImage src='/image/js.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
  <LazyLoadImage src='/image/git.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
  <LazyLoadImage src='/image/githup.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
<LazyLoadImage src='/image/react.png' loading='lazy' className='windSvg lo:h-16 mx-1 lo:w-16 ' />
<LazyLoadImage src='/image/vite.png' loading='lazy' className='windSvg lo:h-16 mx-1 ' />
